...
public class updateProductInDatabase extends HttpServlet {
  ...
  Products a = new Products();
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            helper.updateProduct(a.getProductId(), a.getProductName(), a.getProductType() , a.getPrice(), a.getDescription(), a.getPhoto());

            RequestDispatcher rd = request.getRequestDispatcher("DisplayProudct");
