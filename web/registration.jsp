...
<div id="main_container">
  ...
  <div id="main_content">
    ...
    <div class="center_content">
      <div class="center_title_bar">Registeretion</div>
      ...
      <div class="prod_box_big">
        ...
        <div class="center_prod_box_big">
          <div class="contact_form">
            <div class="form_row">
          <label class="contact"><strong>UserID: </strong></label>
             <input type="text" name="UserId" value="" class="contact_input" />
            </div>
             <div class="form_row">
              <label class="contact"><strong>User Name: </strong></label>
              <input type="text" name="UserName" value="" class="contact_input" />
            </div>
            <div class="form_row">
              <label class="contact"><strong>Email:  </strong></label>
              <input type="text" name="Email" value="" class="contact_input" />
            ...
            <div class="form_row">
              <label class="contact"><strong>Gender:</strong>
              </label> 
             <input type="radio" name="Gender" value="male"  />Male
             <input type="radio" name="Gender" value="female"  />Female
		    </div>
            <div class="form_row">
                <input   name="action" type="submit" value="Regist" />
            </div>
          </div>
        </div>
